...
do
    ...
    case $opcion in
        ...
        "Web Sukigsx")
            zenity --text-info --title="Web de Sukigsx, Diseñador de MegaTools" --html --url="https://repositorio.mbbsistemas.es" --ok-label="Salir" --cancel-label="Atras" --width=10000 --height=10000
            if [ $? = 0 ]; then
